  ...
  return (
    <div className="playfair-font  min-h-screen flex items-center justify-center p-4 sm:p-6 md:p-8 bg-gradient-to-br bg-black relative overflow-hidden">
      ...
      <div className="relative lg:border  border-white/15 lg:bg-black/20 border-0 backdrop-blur-xl flex flex-col lg:flex-row w-full max-w-6xl mx-auto  lg:rounded-2xl shadow-2xl overflow-hidden ">
        ...
        <div className="rounded-2xl lg:rounded-none w-full lg:w-1/2 p-6 sm:p-10 flex flex-col relative  border border-white/15 lg:border-0">
          {/* LOGO */}
          <Zync/>
        ...
        <div className="mt-[200px]  border rounded-2xl lg:rounded-none border-white/15 lg:border-0  lg:mt-0 lg:flex w-full lg:w-1/2 bg-gradient-to-br from-gray-900 via-slate-800 to-gray-900 items-center justify-center relative overflow-hidden">
