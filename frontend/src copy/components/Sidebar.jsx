...
const Sidebar = () => {
  ...
  return (
    <aside className="playfair-font  w-64 bg-black border-r border-white/40 hidden lg:flex flex-col h-screen sticky top-0">
      <div className="p-5 border-b border-gray-800">
        <Link to="/" className="flex items-center gap-2.5 group">
          <Navigation className="w-12 h-12 text-amber-600 group-hover:rotate-180 transition-transform duration-700 text-transparent bg-clip-text bg-gradient-to-r from-amber-400 via-orange-400 to-yellow-500 tracking-wider animate-pulse" />
