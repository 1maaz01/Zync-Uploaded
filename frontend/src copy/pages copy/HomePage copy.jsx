...
const HomePage = () => {
  ...
  return (
<div className="p-4 sm:p-6 lg:p-8 bg-gradient-to-br from-slate-50 to-blue-50 min-h-screen playfair-font ">
      <div className="container mx-auto space-y-10">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
          <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">Your Friends</h2>
          <Link 
            to="/notifications" 
        ...
        <section>
          <div className="mb-6 sm:mb-8">
            <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4">
              <div>
                <h2 className="text-2xl sm:text-3xl font-bold tracking-tight text-gray-900">Meet New Learners</h2>
          ...
          {loadingUsers ? (
            ...
            <div className="bg-white rounded-2xl p-8 text-center shadow-sm border border-gray-200">
              ...
              <h3 className="font-semibold text-lg mb-2 text-gray-900">No recommendations available</h3>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
              {recommendedUsers.map((user) => {
                ...
                return (
                  <div
                    key={user._id}
                    className="bg-white rounded-2xl shadow-sm hover:shadow-lg transition-all duration-300 border border-gray-200 hover:border-blue-300"
                  >
