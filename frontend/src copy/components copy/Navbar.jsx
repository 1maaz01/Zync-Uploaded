...
const Navbar = () => {
  ...
  return (
<nav className="playfair-font   bg-white dark:bg-gray-900 border-b border-gray-200 dark:border-gray-700 sticky top-0 z-30 h-16 flex items-center shadow-sm backdrop-blur-sm bg-opacity-95 dark:bg-opacity-95">
