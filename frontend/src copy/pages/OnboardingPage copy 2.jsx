              ...
              <form onSubmit={handleSubmit} className="space-y-8">
                ...
                <div className="flex flex-col items-center justify-center space-y-6">
                  ...
                  <div className="relative group">
                    ...
                    <div className="relative w-24 h-24 rounded-full bg-gradient-to-br from-yellow-600 to-orange-600 overflow-hidden ring-4 ring-orange-500/30 transition-all duration-300 group-hover:ring-orange-700/50 group-hover:scale-105">
                  ...
                  <button 
                    ...
                    className="relative inline-flex items-center px-8 py-4 bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 hover:opacity-90 text-white font-semibold rounded-xl l transform hover:scale-105 transition-all duration-200 shadow-lg hover:shadow-purple-500/25 group overflow-hidden"
                  >
                ...
                <div className="pt-6 w-full flex items-center justify-center">
                  <button 
                    className={`relative px-4 py-4 rounded-2xl font-bold text-white text-lg transition-all duration-200 flex items-center justify-center overflow-hidden group ${
                      isPending 
                        ? 'bg-gray-700 cursor-not-allowed' 
                        : 'bg-gradient-to-r from-yellow-600 to-orange-600 hover:from-yellow-700 hover:to-orange-700 hover:opacity-90 transform hover:scale-[1.02] shadow-2xl hover:shadow-purple-500/25'
                    }`}
                    disabled={isPending} 
                    type="submit"
                  >
