...
import { BellIcon, LogOutIcon, Menu, Navigation } from "lucide-react";
      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-end w-full">
          ...
          <div className="lg:hidden flex items-center gap-3 sm:gap-4 ml-auto">
            <Link to={"/"}>
              <button className="left-3 top-3 absolute  p-2 rounded-full hover:bg-gray-100 dark:hover:bg-gray-800 transition-colors duration-200 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:ring-offset-2">
